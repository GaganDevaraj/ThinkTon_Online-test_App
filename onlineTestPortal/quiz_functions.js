...
function renderQuiz() 
{
  ...
  {
    document.writeln('<pre class="question" style="font-weight:600; /* padding-top:20px; */ font-size: 16px; font-family: sans-serif;">' + questions[i] + ' <span id="result_' + i + '"><img src="blank.gif" style="border:0" alt="" /></span></pre>');
